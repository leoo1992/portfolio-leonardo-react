                    ...
                    <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li className="nav-item">
                            <a href="#projetos" className="nav-link" onClick={closeNav}>
                                <h2 className="nav-texto3">
                                    <FontAwesomeIcon icon={["fa", "fa-chalkboard-user"]} /> Projetos
                                </h2>
                            </a>
                        </li>
                        <li className="nav-item">
                ...
                <div className="container-fluid p-0 m-0 justify-content-center align-content-center align-self-center align-items-center">
                    <div className="row p-0 m-0 justify-content-center align-content-center align-self-center align-items-center">
                        <p className="texto-sobre m-0 p-0 fw-bold">
                            Me chamo Leonardo Santos Custódio, nasci em abril de 1992, sou natural
                            de Imbituba, Santa Catarina. Atualmente estou finalizando o curso
                            Técnico em Desenvolvimento de Sistemas no SENAI de Criciúma, com
                            formação para 12/2023. Almejo em sequência iniciar uma faculdade de
                            Engenharia de Software. Sei que tenho muito a agregar para a área de
                            tecnologia, pois sou fascinado por sistemas e por tudo de amplo e
                            inovador que podem transformar a nossa realidade.
                        </p>
                    </div>
                    <br id="projetos" />
                </div>
